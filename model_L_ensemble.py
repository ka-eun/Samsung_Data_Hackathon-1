from preprocessing import category_L_preprocessing
...
def createModel(inputs, outputs):
    ...
    o1 = Activation('softmax', name='L')(x)
...
def main_2():
    ...
    while cnt < num_models:
        ...
        try:
            plot_model(model, to_file='./models/2_model_' + str(cnt) + '.png', show_shapes=True, show_layer_names=True)
        except:
            pass
